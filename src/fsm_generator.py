...
def generate_actions_wrapper(fsm_name, actions_template,  dir_to_save):
    pass


def generate_state_wrapper(fsm_name, state, extern_attribs, state_templates, attribute_template, dir_to_save):
    current_datetime = datetime.datetime.now()
    current_date = current_datetime.strftime("%d %b %Y")
    ...
    for sub_state in state.sub_states:
        generate_state_wrapper(fsm_name, sub_state, extern_attribs, state_templates, attribute_template, dir_to_save)
...
def generate_fsm_wrappers(uml_diagram, dir_to_save, state_templates=[], attribute_templates=[]):
    ...
    for state in states:
        generate_state_wrapper(fsm_name, state, external_attributes, state_templates, attribute_templates[1], dir_to_save)
...
if __name__ == '__main__':
    ...
    try:
        generate_fsm_wrappers(args.uml_diagram, args.dir_to_save, args.state_templates, args.attribute_templates)
